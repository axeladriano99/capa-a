					...
					<div class="auth-box card">
						<div class="card-block">
							...
							<div class="form-group form-primary">
								<input type="text" name="name" class="form-control" placeholder="Nombre" value="{{ old('name') }}" autofocus required>
							</div>
							<div class="form-group form-primary">
								<input type="email" name="email" class="form-control" value="{{ $invitation->email }}" disabled>
							</div>
							<div class="form-group form-primary">
								<input type="text" name="phone" class="form-control" placeholder="WhatsApp" value="{{ old('phone') }}" required>
							</div>
							...
							<div class="form-group form-primary">
								<input type="text" name="payment_data" class="form-control" placeholder="Tel/Email/Cta paypal/nequi y otros" value="{{ old('payment_data') }}" required>
							</div>
