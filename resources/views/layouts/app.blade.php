...
<head>
	<title>@yield('title') - OpenContact</title>
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="{{ route('home') }}">
                            <img class="img-fluid" style="max-width: 72%;" src="{{asset('assets/images/logo.png') }}" alt="Theme-Logo">
                        </a>
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        <li style="padding: 0;">
                                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="display: block; padding: 1em 20px;">
